...
double p[MAXBALLS][3], v[MAXBALLS][3];
double po[MAXBALLS][3], ve[MAXBALLS][3];
int balArr[MAXCOLL][2];
double timArr[MAXCOLL];
int fBalArr[MAXCOLL][2];
double fTimArr[MAXCOLL];
...
double findCollision(int i, int j)
{
	double dx, dy, dz, dvx, dvy, dvz, a, b, c, D, sD, t1, t2, tCol;
...
void processCollision(int b1, int b2, double tc)
{
	double dx, dy, dz, vb1d, vb2d, nv; 
...
{
	double tij, maxNegTime, minPosTime;
